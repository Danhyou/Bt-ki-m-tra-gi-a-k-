...
using DoThanhDanh.Models;
using PagedList;

namespace DoThanhDanh.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            {
                products = products.Where(s => s.Code.ToUpper().Contains(searchString.ToUpper()) || s.Name.ToUpper().Contains(searchString.ToUpper())
                || s.ShortName.ToUpper().Contains(searchString.ToUpper()) || s.Note.ToUpper().Contains(searchString.ToUpper()));
            }
            switch (sortOrder)
            {
                case "name_desc":
